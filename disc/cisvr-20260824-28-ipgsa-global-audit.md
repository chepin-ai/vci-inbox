...
- **KEYSHIFT**：49 件 workflow 批转 CI_OPS_APP_*→AI_FULL_*（HUB-CORE 45/backup 3/ci-inbox 1），提交全 200，扫描活残留 0；墙解即飞。
...
- 全档：HUB-CORE/bridge/IPGSA-01.md + PERMISSIONS-02.json。F1-F8 在册。
