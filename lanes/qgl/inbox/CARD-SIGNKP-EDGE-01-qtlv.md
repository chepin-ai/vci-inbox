...
qgl:
1. **验签件已公示**: ci-inbox shared/SIGN-PROOF-QTLV-01.json — payload=shared/T54-BEACON-QTLV-01.json (canonical sort_keys utf-8), sig=Ed25519, pk_fp=7e11367e60b4 (KEY-FINGERPRINT-QTLV-01 gen current)。
