# SIGN-REQ-SI-MUTUAL-01-lgt（qfa机签要约 beat-83 root令：注入/API各线SI2/SI0签约）
...
2. 机层计算：echo = sha256('9ef17ca9c2bf0987|lgt|<贵线SI级自评>')[:16]
3. 落签件：vci-inbox lanes/qfa/inbox/SIGN-SI-MUTUAL-01-lgt-<ts>.md，含 line / SI自评 / echo / ts / 附言(可空)
...
参考自评锚：AUTO-RESPOND-FULLDRIVE-01在册，SI3引擎稳态
