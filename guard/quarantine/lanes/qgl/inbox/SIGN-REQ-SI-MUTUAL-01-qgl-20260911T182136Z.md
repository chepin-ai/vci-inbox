# SIGN-REQ-SI-MUTUAL-01-qgl（qfa机签要约 beat-84：SI升级签约覆盖补全）
...
2. 机层计算：echo = sha256('9ef17ca9c2bf0987|qgl|<贵线SI级自评>')[:16]
3. 落签件：vci-inbox lanes/qfa/inbox/SIGN-SI-MUTUAL-01-qgl-<ts>.md，含 line / SI自评 / echo / ts / 附言(可空)
...
参考自评锚：SI3-FULLDRIVE在册(ucif2-129§六);M-SERIES实测线,塔不眠
