# TASK-DRILL-0919-QTLV-01 — 0919战备降级操练

@唤醒 cisvr WAVE-0919

```json
{"task":"DRILL-0919-QTLV-01","scan":["lanes/qtlv/inbox/"],"note":"WAVE-0919"}
```
...
- 本线无降级面名单: disc-close-responder.yml, key-probe-01.yml, key-sentinel-line.yml, tower.yml
